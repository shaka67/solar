...
import com.ouer.solar.sms.server.spring.SmsSpringConfig;
...
public class BootstrapTestCase {
	...
	public static void main(String[] args) throws Exception {
		...
		context.register(SmsSpringConfig.class, ProfileSpringConfig.class);
		context.refresh();

		final SmsLifecycle lifecycle = context.getBean(SmsLifecycle.class);
		lifecycle.start();
		lifecycle.stop();
		lifecycle.start();
