...
public class ReflectionUtilTest extends CachedLogger {
    ...
    public void findAllMethodAnnotation() {
        ...
        assertNull(ReflectionUtil.findAllMethodAnnotation((Class<?>) null, AnnotationClass.TestAnnotation.class));
        assertNull(ReflectionUtil.findAllMethodAnnotation(AnnotationClass.class, (Class<? extends Annotation>) null));

        List<AnnotationClass.TestAnnotation> list =
                ReflectionUtil.findAllMethodAnnotation(AnnotationClass.class, AnnotationClass.TestAnnotation.class);
    ...
    public void invokeMethod() {
        ...
        assertNull(ReflectionUtil.invokeMethod((Object) null, (String) null, Emptys.EMPTY_CLASS_ARRAY, (Object[]) null));
