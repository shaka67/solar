...
public abstract class AbstractListMapViewTest extends AbstractTest {
    ...
    public void containsAll() {
        ...
        items = CollectionUtil.createArrayList(newItem("aaa", "111"), newItem("bbb", "222"), newItem("ccc", "333"));
        assertTrue(view1.containsAll(items));

        items = CollectionUtil.createArrayList(newItem("aaa", null), newItem(null, "111"));
    ...
    /**
     * 从<code>ListMap</code>中取得view. 可能是<code>ListMap.entryList()</code>, <code>ListMap.keyList()</code> 和
     * <code>ListMap.valueList()</code> 等方法返回的结果.
     * 
