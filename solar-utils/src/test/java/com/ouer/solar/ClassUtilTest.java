...
public class ClassUtilTest extends CachedLogger {
    ...
    public void getFriendlyClassName() {
        // null
        assertNull(ClassUtil.getFriendlyClassName((Object) null));
        ...
        // 非数组
        assertGetFriendlyClassName("java.util.ArrayList", CollectionUtil.createArrayList());

        // 内联类/本地类/匿名类
        assertGetFriendlyClassName("com.qf.common.ClassUtilTest.Inner", new Inner());
        assertGetFriendlyClassName("com.qf.common.ClassUtilTest.Inner[]", new Inner[0]);
        // FIXME
        // class Local {
        // }
        //
        // assertGetFriendlyClassName("com.qf.common.ClassUtilTest.1Local", new Local());
        // assertGetFriendlyClassName("com.qf.common.ClassUtilTest.1Local[]", new Local[0]);
        ...
        Object anonymous = new Serializable() {
             ...
             * 
             */
            private static final long serialVersionUID = -6298784097675767965L;

        };

        assertGetFriendlyClassName("com.qf.common.ClassUtilTest.1", anonymous);
    ...
    private void assertGetFriendlyClassName(String result, Object object) {
        // object
        assertEquals(result, ClassUtil.getFriendlyClassName(object));
    ...
    public void getSimpleClassName() {
        // null
        assertNull(ClassUtil.getSimpleClassName((Object) null));
        ...
        // 内联类
        assertGetSimpleClassName("ClassUtilTest.Inner", new Inner(), true);
        assertGetSimpleClassName("ClassUtilTest$Inner", new Inner(), false);

        // 内联类/本地类/匿名类
        assertGetSimpleClassName("ClassUtilTest.Inner", new Inner(), true);
        assertGetSimpleClassName("ClassUtilTest$Inner[]", new Inner[0], false);
        // FIXME
        // class Local {
        // }
        //
        // assertGetSimpleClassName("ClassUtilTest.2Local", new Local(), true);
        // assertGetSimpleClassName("ClassUtilTest$2Local", new Local(), false);
        // assertGetSimpleClassName("ClassUtilTest.2Local[]", new Local[0], true);
        // assertGetSimpleClassName("ClassUtilTest$2Local[]", new Local[0], false);

        Object anonymous = new Serializable() {
            private static final long serialVersionUID = 4375828012902534105L;
        };

        assertGetSimpleClassName("ClassUtilTest.2", anonymous, true);
        assertGetSimpleClassName("ClassUtilTest$2", anonymous, false);
    ...
    private void assertGetSimpleClassName(String result, Object object, boolean proccessInnerClass) {
        if (proccessInnerClass) {
            // object
            assertEquals(result, ClassUtil.getSimpleClassName(object));
            assertEquals(result, ClassUtil.getSimpleClassName(object, true));
            ...
            // object
            assertEquals(result, ClassUtil.getSimpleClassName(object, proccessInnerClass));
    ...
    public void getSimpleMethodSignature() throws Exception {
        ...
        assertMethod("public final void ClassUtilTest.MyClass.func()", m1, true, true, true, true);
        assertMethod(
                "private static int ClassUtilTest.MyClass.func(String, long[]) throws IOException, RuntimeException",
        ...
        assertMethod("void ClassUtilTest.MyClass.func()", m1, false, true, true, true);
        assertMethod("int ClassUtilTest.MyClass.func(String, long[]) throws IOException, RuntimeException", m2, false,
                true, true, true);

        // no modifiers, no returnType, className, exceptionTypes
        assertMethod("ClassUtilTest.MyClass.func()", m1, false, false, true, true);
        assertMethod("ClassUtilTest.MyClass.func(String, long[]) throws IOException, RuntimeException", m2, false,
                false, true, true);
        ...
        assertEquals("ClassUtilTest.MyClass.func()", ClassUtil.getSimpleMethodSignature(m1, true));
        assertEquals("func()", ClassUtil.getSimpleMethodSignature(m1, false));
        assertEquals("ClassUtilTest.MyClass.func(String, long[])", ClassUtil.getSimpleMethodSignature(m2, true));
    ...
    public void locateClass() {
        assertThat(ClassUtil.locateClass(org.slf4j.Logger.class), containsRegex("slf4j-api-\\S+\\.jar$"));
        assertThat(ClassUtil.locateClass(ClassUtilTest.class.getName()),
