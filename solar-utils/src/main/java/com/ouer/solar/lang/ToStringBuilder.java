...
import com.ouer.solar.internal.IndentableStringBuilder;

/**
 * 方便实现<code>toString()</code>方法。
 * 
 * @author <a href="indra@ixiaopu.com">chenxi</a>
 * @version create on 2015-2-11 上午10:59:57
 */
public class ToStringBuilder {
     ...
     * 
     * @author <a href="indra@ixiaopu.com">chenxi</a>
     * @version create on 2015-2-11 上午11:05:33
     */
    ...
    public static class MapBuilder implements StructureBuilder {
        ...
        public MapBuilder append(String key, Object value) {
            key = StringUtil.defaultIfNull(key, NULL_STR);
            map.put(key, value);
            return this;
        }
