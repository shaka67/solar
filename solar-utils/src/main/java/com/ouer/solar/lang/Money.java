...
public class Money implements Serializable, Comparable<Money> {
     ...
     */
    protected static final Map<String, Map<String, String>> CURRENCY_DISPLAY_UNIT_MAP = CollectionUtil.createHashMap();
    // 进行初始化工作
    static {
        // 簡體中文的對應錶
        Map<String, String> zhCNMap = CollectionUtil.createHashMap();
        zhCNMap.put("CNY", "元");
        zhCNMap.put("POINT", "积分");
        CURRENCY_DISPLAY_UNIT_MAP.put("zh_CN", zhCNMap);

        // 繁體的對應錶
        Map<String, String> zhHKMap = CollectionUtil.createHashMap();
        zhHKMap.put("CNY", "元");
