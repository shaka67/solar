...
public abstract class PinyinUtil {
    ...
    private static final int compare(String str1, String str2) {
    ...
    public static final int chineseCompareTo(String string1, String string2) {
    ...
    private static final int getCharCode(String string) {
     ...
     */
    @Check
    public static final String getBeginCharacter(String string) {
     ...
     */
    public static final String getFirstSpell(String string) {
        String result = null;
