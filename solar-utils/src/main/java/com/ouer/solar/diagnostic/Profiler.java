 ...
 */
package com.ouer.solar.diagnostic;
 ...
 */
public final class Profiler extends Emptys {
    ...
    public static String dump() {
        return dump(EMPTY_STRING, EMPTY_STRING);
    }
    ...
    public static String dumpIfFirst() {
        return dumpIfFirst(EMPTY_STRING, EMPTY_STRING);
    }
     ...
     * 
     * @author <a href="indra@ixiaopu.com">chenxi</a>
     * @version create on 2015-6-16 上午1:16:56
     */
    public static final class Entry {
        ...
        private Entry(Object message, Entry parentEntry, Entry firstEntry) {
            ...
            this.firstEntry = ObjectUtil.defaultIfNull(firstEntry, this);
        ...
        public String getMessage() {
            ...
            if (Message.class.isInstance(message)) {
                ...
                messageString =
                        (level == MessageLevel.DETAILED_MESSAGE) ? messageObject.getDetailedMessage() : messageObject
                                .getBriefMessage();
		...
		public String toString() {
            return toString(EMPTY_STRING, EMPTY_STRING);
        }
     ...
     * 
     * @author <a href="indra@ixiaopu.com">chenxi</a>
     * @version create on 2015-6-16 上午1:22:05
     */
    ...
    public interface Message {
         ...
         * 获取消息级别
         * 
         * @param entry 一个<code>Entry</code>
         * @return 消息级别
         */
