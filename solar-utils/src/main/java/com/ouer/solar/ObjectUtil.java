...
public abstract class ObjectUtil {
    ...
    public static <A extends Appendable> A appendIdentityToString(A buffer, Object object) {
        ...
        try {
            if (object == null) {
                ...
                buffer.append(ClassUtil.getFriendlyClassName(object));
    ...
    public static String toString(Object object, String nullStr) {
        ...
        PrimitiveArrayType primitiveArrayType = PrimitiveArrayType.find(object.getClass());
        if (primitiveArrayType != null) {
            return primitiveArrayType.toString(object);
        }
    ...
    public static StringBuilder appendIdentityToString(StringBuilder builder, Object object) {
        ...
        builder.append(ClassUtil.getSimpleClassName(object));
