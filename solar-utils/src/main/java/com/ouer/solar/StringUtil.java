...
import static com.ouer.solar.Emptys.EMPTY_STRING;
...
public abstract class StringUtil {
    ...
    private static boolean startsWith(final CharSequence str, final CharSequence prefix, final boolean ignoreCase) {
        ...
        return CharUtil.regionMatches(str, ignoreCase, 0, prefix, 0, prefix.length());
    }

    public static boolean startsWithAny(final CharSequence string, final CharSequence...searchStrings) {
        if (StringUtil.isEmpty(string) || ArrayUtil.isEmpty(searchStrings)) {
            return false;
        }
