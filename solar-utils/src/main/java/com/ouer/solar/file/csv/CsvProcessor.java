 ...
 */
package com.ouer.solar.file.csv;

import static com.ouer.solar.StringPool.Charset.GBK;
...
import com.ouer.solar.file.FieldDesc;
import com.ouer.solar.file.FileBeanInfo;
import com.ouer.solar.file.FileProcessor;
import com.ouer.solar.file.ProcessedCache;
import com.ouer.solar.io.ByteArray;
import com.ouer.solar.io.ByteArrayOutputStream;
import com.ouer.solar.io.ReaderUtil;
...
public class CsvProcessor implements FileProcessor {
    ...
    private final Computable<String, Field[]> fieldCache = ConcurrentCache.createComputable();
